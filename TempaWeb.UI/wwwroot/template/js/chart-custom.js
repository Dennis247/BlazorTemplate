...
if (jQuery('#apex-radialbar-chart').length) {
    var options = {
        ...
        colors: ['#0f5b9b', '#4F6272', '#e64141', '#ffd400'],
...
if (jQuery('#apex-pie-chart').length) {
    var options = {
        ...
        colors: ['#0f5b9b', '#4F6272', '#e64141', '#ffd400', '#00d0ff'],
        responsive: [{
            breakpoint: 480,
            options: {
                chart: {
...
if (jQuery('#am-simple-chart').length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#0f5b9b"), ];
...
if (jQuery('#am-columnlinr-chart').length) {
    am4core.ready(function() {
        ...
        lineSeries.stroke = am4core.color("#0f5b9b");
...
if (jQuery('#am-polar-chart').length) {
    am4core.ready(function() {
        ...
        range.axisFill.fill = am4core.color("#0f5b9b");
...
if (jQuery('#am-polarscatter-chart').length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#0f5b9b"), am4core.color("#ffd400"), am4core.color("#4F6272")];
...
if (jQuery('#am-3dpie-chart').length) {
    am4core.ready(function() {
        ...
        series.colors.list = [am4core.color("#0f5b9b"), am4core.color("#4F6272"), am4core.color("#e64141"),
...
if (jQuery('#am-layeredcolumn-chart').length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#4F6272"), am4core.color("#0f5b9b")];
...
if (jQuery('#morris-bar-chart').length) {
    Morris.Bar({
        ...
        ykeys: ['y', 'z', 'a'],
        labels: ['Y', 'Z', 'A'],
        barColors: ['#0f5b9b', '#00d0ff', '#4F6272'],
...
if (jQuery('#chart-task').length) {
    am4core.ready(function() {
        ...
        series.colors.list = [am4core.color("#0f5b9b"), am4core.color("#c25a72"), am4core.color("#885e72"),
